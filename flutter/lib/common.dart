...
import 'package:rustdesk_lan/common/formatter/id_formatter.dart';
...
import 'package:rustdesk_lan/utils/platform_channel.dart';
...
import 'package:rustdesk_lan/native/win32.dart'
    if (dart.library.html) 'package:rustdesk_lan/web/win32.dart';
import 'package:rustdesk_lan/native/common.dart'
    if (dart.library.html) 'package:rustdesk_lan/web/common.dart';
...
Future<bool> matchPeer(
  ...
  if (peer.ip.toLowerCase().contains(searchText)) {
    return true;
  }
  ...
  if (type != null && id != null) {
    switch (type) {
      ...
      case UriLinkType.fileTransfer:
        Future.delayed(Duration.zero, () {
          rustDeskWinManager.newFileTransfer(id!, password: password);
        });
        break;
      case UriLinkType.viewCamera:
        Future.delayed(Duration.zero, () {
          rustDeskWinManager.newViewCamera(id!, password: password);
        });
        break;
      case UriLinkType.portForward:
        Future.delayed(Duration.zero, () {
          rustDeskWinManager.newPortForward(id!, false, password: password);
        });
        break;
      case UriLinkType.rdp:
        Future.delayed(Duration.zero, () {
          rustDeskWinManager.newPortForward(id!, true, password: password);
        });
        break;
      case UriLinkType.terminal:
        Future.delayed(Duration.zero, () {
          rustDeskWinManager.newTerminal(id!, password: password);
        });
        break;
    }
...
// Open a tab (preferred) or a window to show this monitor.
//
