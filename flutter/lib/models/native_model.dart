...
class PlatformFFI {
  ...
  RustdeskLan get ffiBind => _ffiBind;
  ...
  Future<void> init(String appType) async {
    ...
    try {
      ...
      _ffiBind = RustdeskLanImpl(dylib);
      ...
      try {
        if (isAndroid) {
          // Use app-accessible external directory on Android.
          _homeDir = (await getExternalStorageDirectory())?.path ?? _dir;
        } else if (isIOS) {
  ...
  void _startListenEvent(RustdeskLan rustdeskImpl) {
    final appType =
